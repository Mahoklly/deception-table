...
en: {
  ...
  coins_lost: "-{n} coins",
  bet_prompt: "Side bet: who takes the bullet this round?",
  bet_skip: "Skip Betting",
  bet_stake_small: "Bet {n} 🪙",
  bet_stake_medium: "Bet {n} 🪙",
  bet_stake_allin: "All In ({n} 🪙)",
  bet_placed: "Bet placed on {n}",
  bet_win: "Your bet paid off! +{a} coins",
  bet_lose: "Your bet was wrong. -{a} coins",
  bet_push: "No one died — bet refunded",
  shop_title: "🛍️ Shop",
  shop_balance: "Balance: {n} 🪙",
  shop_cat_felt: "Table Felt",
  shop_cat_chips: "Chip Theme",
  shop_cat_trim: "Table Trim",
  shop_owned: "Owned",
  ...
  wrong_vote_penalty: "Wrong vote — the accusers are fined, and it's all paid straight to the seat they wrongly executed",
},
ku: {
  ...
  coins_earned: "+{n} دراو",
  coins_lost: "-{n} دراو",
  bet_prompt: "شەرتی لاوەکی: ئەم خولە کێ تفەنگەکە دەگرێت؟",
  bet_skip: "پەڕاندنی شەرتبەندی",
  bet_stake_small: "شەرت ببەستە {n} 🪙",
  bet_stake_medium: "شەرت ببەستە {n} 🪙",
  bet_stake_allin: "هەموو شتێک ({n} 🪙)",
  bet_placed: "شەرتت لەسەر {n} بەست",
  bet_win: "شەرتەکەت سەرکەوتوو بوو! +{a} دراو",
  bet_lose: "شەرتەکەت هەڵە بوو. -{a} دراو",
  bet_push: "کەس نەمرد — شەرتەکە گەڕایەوە",
  shop_title: "🛍️ فرۆشگا",
  shop_balance: "باڵانس: {n} 🪙",
  shop_cat_felt: "ڕەنگی خشتە",
  shop_cat_chips: "شێوازی چیپ",
  shop_cat_trim: "ڕازاندنەوەی خشتە",
  shop_owned: "هی تۆیە",
  ...
  wrong_vote_penalty: "دەنگدانی هەڵە — دەنگدەرەکان جەریمە دەکرێن، و هەمووی راستەوخۆ دەدرێت بەو کورسییەی بە هەڵە لێدرا",
},
};
